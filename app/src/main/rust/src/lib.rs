...
const _INIT_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
...
const _CLONE_REPO_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_cloneRepoLib",
...
const _CURRENT_SIGNATURE_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_currentSignatureLib",
    static extern fn current_signature_lib() -> JObject,
};

const _PUSH_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_pushLib",
    static extern fn push_lib(cred: JObject) -> jint,
};

const _PULL_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_pullLib",
...
const _GENERATE_SSH_KEYS_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_generateSshKeysLib",
...
const _GET_URL_INFO_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_getUrlInfoLib",
...
const _LAST_ERROR_MESSAGE_LIB_METHOD: NativeMethod = native_method! {
    java_type = "io.github.leonhardweiler.diffusion.manager.GitManagerKt",
    export = "Java_io_github_leonhardweiler_diffusion_manager_GitManagerKt_lastErrorMessageLib",
