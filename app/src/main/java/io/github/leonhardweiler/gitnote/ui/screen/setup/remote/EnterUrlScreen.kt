...
import io.github.leonhardweiler.gitnote.helper.NetworkPermissionHelper
import kotlinx.coroutines.launch
import io.github.leonhardweiler.gitnote.manager.getUrlInfoLib
...
private fun UrlTextField(url: MutableState<TextFieldValue>) {
    ...
    OutlinedTextField(
        ...
        placeholder = {
            Text(text = "git@github.com:LeonhardWeiler/gitnote.git")
        },
        singleLine = true,
